...
% [train_data,test_data]=data_gen_temp(); %dict_size=30-30-5
% confidence=0.99 大部分实验各算法都很好  
% [train_data,test_data]=data_gen_level(); %30-30-5 ldcl效果不太稳定
[train_data,test_data]=data_gen_flow();%40-40-15  
...
d_sizes=[40,40,15]; % 特色字典1,特色字典2,公共字典
